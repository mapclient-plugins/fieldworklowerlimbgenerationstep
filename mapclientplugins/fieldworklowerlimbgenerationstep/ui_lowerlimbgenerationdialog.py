...
#
# Created: Tue Jun 16 23:38:21 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 332, 388))
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 334, 388))
        ...
        self.formLayout_5.setWidget(2, QtGui.QFormLayout.FieldRole, self.doubleSpinBox)
        ...
        self.page_reg.setGeometry(QtCore.QRect(0, 0, 332, 389))
        ...
        self.landmarkErrorLineEdit = QtGui.QLineEdit(self.errorGroup)
        self.landmarkErrorLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.landmarkErrorLineEdit.setReadOnly(True)
        self.landmarkErrorLineEdit.setObjectName("landmarkErrorLineEdit")
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.FieldRole, self.landmarkErrorLineEdit)
        ...
        self.mDistLineEdit = QtGui.QLineEdit(self.errorGroup)
        self.mDistLineEdit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.mDistLineEdit.setReadOnly(True)
        self.mDistLineEdit.setObjectName("mDistLineEdit")
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.FieldRole, self.mDistLineEdit)
        self.verticalLayout_2.addWidget(self.errorGroup)
        self.toolBox.addItem(self.page_reg, "")
        self.Screenshot = QtGui.QWidget()
        self.Screenshot.setGeometry(QtCore.QRect(0, 0, 332, 388))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.landmarkErrorLabel.setText(QtGui.QApplication.translate("Dialog", "Landmark Error:", None, QtGui.QApplication.UnicodeUTF8))
