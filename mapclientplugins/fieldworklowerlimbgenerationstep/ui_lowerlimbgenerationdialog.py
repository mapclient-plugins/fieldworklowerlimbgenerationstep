...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.doubleSpinBox_hipx = QDoubleSpinBox(self.page)
        self.doubleSpinBox_hipx.setObjectName(u"doubleSpinBox_hipx")
        self.doubleSpinBox_hipx.setMinimum(-360.000000000000000)
        self.doubleSpinBox_hipx.setMaximum(360.000000000000000)

        self.horizontalLayout_13.addWidget(self.doubleSpinBox_hipx)

        self.doubleSpinBox_hipy = QDoubleSpinBox(self.page)
        self.doubleSpinBox_hipy.setObjectName(u"doubleSpinBox_hipy")
        self.doubleSpinBox_hipy.setMinimum(-360.000000000000000)
        self.doubleSpinBox_hipy.setMaximum(360.000000000000000)

        self.horizontalLayout_13.addWidget(self.doubleSpinBox_hipy)

        self.doubleSpinBox_hipz = QDoubleSpinBox(self.page)
        self.doubleSpinBox_hipz.setObjectName(u"doubleSpinBox_hipz")
        self.doubleSpinBox_hipz.setMinimum(-360.000000000000000)
        self.doubleSpinBox_hipz.setMaximum(360.000000000000000)
        ...
        self.formLayout_5.setWidget(6, QFormLayout.LabelRole, self.label_22)

        self.horizontalLayout_14 = QHBoxLayout()
        self.horizontalLayout_14.setObjectName(u"horizontalLayout_14")
        self.doubleSpinBox_kneex = QDoubleSpinBox(self.page)
        self.doubleSpinBox_kneex.setObjectName(u"doubleSpinBox_kneex")
        self.doubleSpinBox_kneex.setMinimum(-180.000000000000000)
        self.doubleSpinBox_kneex.setMaximum(180.000000000000000)

        self.horizontalLayout_14.addWidget(self.doubleSpinBox_kneex)

        self.doubleSpinBox_kneey = QDoubleSpinBox(self.page)
        self.doubleSpinBox_kneey.setObjectName(u"doubleSpinBox_kneey")
        self.doubleSpinBox_kneey.setMinimum(-180.000000000000000)
        self.doubleSpinBox_kneey.setMaximum(180.000000000000000)

        self.horizontalLayout_14.addWidget(self.doubleSpinBox_kneey)

        self.doubleSpinBox_kneez = QDoubleSpinBox(self.page)
        self.doubleSpinBox_kneez.setObjectName(u"doubleSpinBox_kneez")
        self.doubleSpinBox_kneez.setMinimum(-180.000000000000000)
        self.doubleSpinBox_kneez.setMaximum(180.000000000000000)

        self.horizontalLayout_14.addWidget(self.doubleSpinBox_kneez)


        self.formLayout_5.setLayout(6, QFormLayout.FieldRole, self.horizontalLayout_14)
        ...
        QWidget.setTabOrder(self.doubleSpinBox_prz, self.doubleSpinBox_hipx)
        QWidget.setTabOrder(self.doubleSpinBox_hipx, self.doubleSpinBox_hipy)
        QWidget.setTabOrder(self.doubleSpinBox_hipy, self.doubleSpinBox_hipz)
        QWidget.setTabOrder(self.doubleSpinBox_hipz, self.doubleSpinBox_kneex)
        QWidget.setTabOrder(self.doubleSpinBox_kneex, self.doubleSpinBox_kneey)
        QWidget.setTabOrder(self.doubleSpinBox_kneey, self.doubleSpinBox_kneez)
        QWidget.setTabOrder(self.doubleSpinBox_kneez, self.pushButton_manual_reset)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Lower Limb Registration", None))
        ...
        self.label_21.setText(QCoreApplication.translate("Dialog", u"Hip Rot.", None))
        self.label_22.setText(QCoreApplication.translate("Dialog", u"Knee Rot.", None))
