...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_14 = QLabel(self.configGroupBox)
        self.label_14.setObjectName(u"label_14")

        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.label_14)

        self.comboBox_side = QComboBox(self.configGroupBox)
        self.comboBox_side.setObjectName(u"comboBox_side")

        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.comboBox_side)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.spinBox_pcsToFit)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.doubleSpinBox_mWeight)
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.doubleSpinBox_markerRadius)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.doubleSpinBox_skinPad)
        ...
        self.formLayout.setLayout(5, QFormLayout.FieldRole, self.verticalLayout)
        ...
        QWidget.setTabOrder(self.comboBox_regmode, self.comboBox_side)
        QWidget.setTabOrder(self.comboBox_side, self.spinBox_pcsToFit)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Configure Lower Limb Registration Step", None))
        ...
        self.label_14.setText(QCoreApplication.translate("Dialog", u"Side:", None))
